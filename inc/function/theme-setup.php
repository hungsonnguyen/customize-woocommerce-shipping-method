...
function wph_scripts() {
    ...
    wp_enqueue_style( 'bootstrap-css', $uri . '/assets/libs/bootstrap/css/bootstrap.min.css', array(), false, 'all'); 

    wp_enqueue_style( 'fontawesome-css', $uri . '/assets/libs/fontawesome/all.min.css', array(), false, 'all');  

    wp_enqueue_style( 'owl-carousel-css', $uri . '/assets/libs/owlcarousel/css/owl.carousel.min.css', array(), false, 'all');    
    wp_enqueue_style( 'owl-carousel-theme', $uri . '/assets/libs/owlcarousel/css/owl.theme.default.min.css', array(), false, 'all');  
      
    wp_enqueue_style( 'mmenujs-css', $uri . '/assets/libs/mmenujs/css/mmenu.min.css', array(), false, 'all');    

    wp_enqueue_style( 'style', $uri . '/assets/css/main.css?v='.time(), array(), false, 'all' );

    /*js*/
    wp_enqueue_script( 'boostrap-js', $uri.'/assets/libs/bootstrap/js/bootstrap.bundle.min.js', array(), false, true );
    wp_enqueue_script( 'owl-carousel-js', $uri.'/assets/libs/owlcarousel/js/owl.carousel.min.js', array(), false, true ); 
    wp_enqueue_script( 'mmenujs-js', $uri.'/assets/libs/mmenujs/js/mmenu.min.js', array(), false, true );    
...
// function wph_search_woocommerce_only( $query ) {
...
//     }
// }
// add_action( 'pre_get_posts', 'wph_search_woocommerce_only' );